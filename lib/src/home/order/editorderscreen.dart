...
import 'package:possystem/src/mycart/edit_my_cart.dart';
...
class EditOrderScreen extends StatefulWidget {
  ...
  const EditOrderScreen({Key? key, required this.tableId, required this.tableName, required this.orderId,})
      : super(key: key);
  @override
                                ...
                                children: [
                                  GestureDetector(
                                    ...
                                    onTap: () async {
                                      if (product.quantity > 0) {
                                        ...
                                        await Postapi()
                                            .delteeditItemToOrder(widget.orderId!, product.slug);
                                        // dismiss dialog after 2 seconds
                                        Future.delayed(Duration(seconds: 2),
                                            () {
                                          Navigator.of(context).pop();
                                  ...
                                  GestureDetector(
                                    onTap: () async {
                                      ...
                                      await Postapi()
                                          .editaddItemToOrder(widget.orderId!, product.slug);
                                      // dismiss dialog after 2 seconds
